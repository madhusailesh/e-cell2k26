  ...
  const eventsList = [
    {
      ...
      description:
        "Eastern India's biggest flagship event brings together a horde of business moguls and industry experts to butt heads for the much needed societal changes.",
...

    {
      ...
      description:
        "Tedx is a program of local, self organized events that brings in live speakers to combine and indulge in discussions. TEDx VSSUT is organized annually inviting speakers from distinguished fields who share their experiences and inspire all.",
...

    {
      ...
      description:
        "Business Model competition is a platform where various startups pitch in their ideas to tackle day to day problems infront of genuine investors who guide them during and even after the event.",
