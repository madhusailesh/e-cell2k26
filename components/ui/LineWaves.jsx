...
void main() {
  ...
  // Smooth alpha calculation so dark areas become completely transparent
...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    // Explicitly enabling alpha blending for transparency
    ...
    // Ensure canvas styling is fully transparent and fills container
  ...
  return <div ref={containerRef} className="w-full h-full pointer-events-none bg-transparent" />;
}