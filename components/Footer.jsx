        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 pb-16 border-b border-white/10">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-neutral-300 space-y-1 font-light pt-2">
              <p><strong className="text-white font-medium">Phone:</strong> 7064214870</p>
              <p><strong className="text-white font-medium">Email:</strong> ecellvssut@gmail.com</p>
            </div>

            {/* Social Icons (SVGs) */}
            <div className="flex items-center gap-3 pt-3">
              <Link href="https://x.com" target="_blank" className="p-2.5 rounded-full bg-neutral-900 hover:bg-white hover:text-black text-neutral-300 transition-all border border-white/10" title="X (Twitter)">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </Link>
              <Link href="https://facebook.com" target="_blank" className="p-2.5 rounded-full bg-neutral-900 hover:bg-white hover:text-black text-neutral-300 transition-all border border-white/10" title="Facebook">
              ...
              <Link href="https://instagram.com" target="_blank" className="p-2.5 rounded-full bg-neutral-900 hover:bg-white hover:text-black text-neutral-300 transition-all border border-white/10" title="Instagram">
              ...
              <Link href="https://linkedin.com" target="_blank" className="p-2.5 rounded-full bg-neutral-900 hover:bg-white hover:text-black text-neutral-300 transition-all border border-white/10" title="LinkedIn">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm font-light text-neutral-400">
              ...
              <li><Link href="/testimonials" className="hover:text-white transition-colors flex items-center gap-2">→ Testimonials</Link></li>
              <li><Link href="/startups" className="hover:text-white transition-colors flex items-center gap-2">→ Startups</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm font-light text-neutral-400">
              ...
              <li><Link href="/events" className="hover:text-white transition-colors flex items-center gap-2">→ IPL Auction</Link></li>
              <li><Link href="/events" className="hover:text-white transition-colors flex items-center gap-2">→ Leadership Summit</Link></li>
            </ul>
          </div>
